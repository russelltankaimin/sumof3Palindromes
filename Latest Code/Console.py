    ...
    if d5!=1:
        ...
        if d(d0-d4+1,base)!=0 and d(d0-d4+2,base)!=0:
            ...
            if d4==0:
                x.append(d3//2)
                y.append(d3-x[2])
                z.append(d(d1-x[2]-y[2]-1,base))
                c.append((x[2]+y[2]+z[2]+1-d1)//base)
                x.append((base-c[2]-z[2])//2)
                y.append(base-c[2]-z[2]-x[3])
                return [[base-2,x[2],x[3],x[2],base-2],[1,y[2],y[3],y[2],1],[base-1,z[2],z[2],base-1]]
            elif d4==1:
                x.append(d3//2)
                y.append(d3-x[2])
                z.append(d(d1-x[2]-y[2]-1,base))
                ...
                x.append((base-c[2]-z[2])//2)
                y.append(base-c[2]-z[2]-x[3])
                return [[base-1,x[2],x[3],x[2],base-1],[1,y[2],y[3],y[2],1],[base-1,z[2],z[2],base-1]]
            elif d4==2:
                x.append(d3//2)
                y.append(d3-x[2])
                z.append(d(d1-x[2]-y[2]-2,base))
                c.append((x[2]+y[2]+z[2]+2-d1)//base)
                if c[2]!=2:
                    x.append((base-c[2]-z[2])//2)
                    y.append(base-c[2]-z[2]-x[3])
                    return [[base-1,x[2],x[3],x[2],base-1],[2,y[2],y[3],y[2],2],[base-1,z[2],z[2],base-1]]
                else:
                    return [[1,2,base-2,base-2,2,1],[1,base-3,1],[base-2]]
            elif d4>=3:
                c4=(d(d3-1,base)+1-d3)//base
                z1=d(d1-d3-1+c4,base)
                c2=(2-c4+d(d3-1,base)+z-d1)//base
            ...
            if d4!=base-1:
                ...
                if d(d1-4,base)==base-1:
                    ...
                    yd=1
                xd=d3+base-yd if d3<y else d3-yd
